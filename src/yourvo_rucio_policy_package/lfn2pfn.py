...
class YourVORSEDeterministicTranslation(RSEDeterministicTranslation):
    ...
    def _module_init_(cls):
        ...
        """
        cls.register(cls.lfn2pfn_yourvo, "yourvo")

    @staticmethod
    def lfn2pfn_yourvo(scope, name, rse, rse_attrs, protocol_attrs):
        """
...
YourVORSEDeterministicTranslation._module_init_()